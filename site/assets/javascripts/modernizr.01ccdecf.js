      ...
      (function (i, d, p) {
        ...
        function s(e) {
          ...
          c._config.enableClasses &&
            ...
            b ? (S.className.baseVal = t) : (S.className = t));
        }
        function a(e, t) {
          if ("object" == typeof e) for (var n in e) v(e, n) && a(n, e[n]);
            ...
            var r = (e = e.toLowerCase()).split("."),
              o = c[r[0]];
            if ((2 === r.length && (o = o[r[1]]), void 0 !== o)) return c;
        ...
        function o(e, t, n, r) {
          var o,
            ...
            u = "modernizr",
            f = m("div"),
            c = ((l = d.body) || ((l = m(b ? "svg" : "body")).fake = !0), l);
          if (parseInt(n, 10))
            for (; n--; )
              ((s = m("div")).id = r ? r[n] : u + (n + 1)), f.appendChild(s);
          return (
            ((o = m("style")).type = "text/css"),
            (o.id = "s" + u),
            (c.fake ? c : f).appendChild(o),
            c.appendChild(f),
            o.styleSheet
        ...
        function h(e, t) {
          ...
          if ("CSS" in i && "supports" in i.CSS) {
            for (; n--; ) if (i.CSS.supports(l(e[n]), t)) return !0;
            return !1;
          }
          if ("CSSSupportsRule" in i) {
            for (var r = []; n--; ) r.push("(" + l(e[n]) + ":" + t + ")");
            return o(
              "@supports (" +
                (r = r.join(" or ")) +
        ...
        function r(e, t, n, r, o) {
          ...
          return y(t, "string") || y(t, "undefined")
            ? (function (e, t, n, r) {
                function o() {
                  s && (delete T.style, delete T.modElem);
                }
                if (((r = !y(r, "undefined") && r), !y(n, "undefined"))) {
                  var i = h(e, n);
                  if (!y(i, "undefined")) return i;
                }
                for (
                  var s, a, l, u, f, c = ["modernizr", "tspan", "samp"];
                  !T.style && c.length;
                ...
                for (l = e.length, a = 0; a < l; a++)
                  if (
                    ...
                    if (r || y(n, "undefined")) return o(), "pfx" !== t || u;
                    try {
                      T.style[u] = n;
                    } catch (e) {}
                    if (T.style[u] !== f) return o(), "pfx" !== t || u;
                  }
                return o(), !1;
              })(s, t, r, o)
            : (function (e, t, n) {
        ...
        (v =
          y((n = {}.hasOwnProperty), "undefined") || y(n.call, "undefined")
            ? function (e, t) {
          ...
          c.addTest(
            "json",
            "JSON" in i && "parse" in JSON && "stringify" in JSON
          ),
          c.addTest(
            "svg",
            !!d.createElementNS &&
        ...
        c.addTest("checked", function () {
          ...
          c.addTest("details", function () {
            ...
            return (
              "open" in n &&
              (C("#modernizr details{display:block}", function (e) {
                e.appendChild(n),
          ...
          c.addTest("fetch", "fetch" in i);
        var _ = "Moz O ms Webkit",
          w = t._config.usePrefixes ? _.split(" ") : [];
        t._cssomPrefixes = w;
        var x = { elem: m("modernizr") };
        c._q.push(function () {
          delete x.elem;
        });
        var T = { style: x.elem.style };
        c._q.unshift(function () {
          delete T.style;
        });
        var P = t._config.usePrefixes ? _.toLowerCase().split(" ") : [];
        (t._domPrefixes = P), (t.testAllProps = r), (t.testAllProps = e);
        var j = "CSS" in i && "supports" in i.CSS,
          O = "supportsCSS" in i;
        c.addTest("supports", j || O),
          ...
          (function () {
            ...
            for (var s in f)
              if (f.hasOwnProperty(s)) {
                ...
                for (
                  r = y(t.fn, "function") ? t.fn() : t.fn, o = 0;
                  o < e.length;
                  o++
                )
