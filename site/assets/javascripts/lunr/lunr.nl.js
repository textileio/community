!(function (r, e) {
  ...
  return function (r) {
    ...
    (r.nl = function () {
      ...
      (r.nl.stemmer =
        ((v = r.stemmerSupport.Among),
        (q = r.stemmerSupport.SnowballProgram),
        (e = new (function () {
          var e,
            i,
            u,
            ...
            _ = new q();
          function s(r) {
            return (_.cursor = r) >= _.limit || (_.cursor++, !1);
          }
          function w() {
              ...
              _.eq_s_b(1, "e") &&
                ...
                b() &&
                  ...
                  _.out_grouping_b(m, 97, 232) &&
                    ((_.cursor = _.limit - r), _.slice_del(), (u = !0), g())));
          }
          function k() {
            var r;
            b() &&
              ...
              _.out_grouping_b(m, 97, 232) &&
                ((_.cursor = _.limit - r),
                _.eq_s_b(3, "gem") ||
                  ((_.cursor = _.limit - r), _.slice_del(), g())));
          }
              ...
              return (
                (function () {
                  for (var r, e, i, n = _.cursor; ; ) {
                    if (((_.bra = _.cursor), (r = _.find_among(o, 11))))
                ...
                (i = _.limit),
                (e = i),
                w() || ((i = _.cursor) < 3 && (i = 3), w() || (e = _.cursor)),
                (_.limit_backward = r),
                (_.cursor = _.limit),
                (function () {
                  var r,
                ...
                (function () {
                  for (var r; ; )
                    if (((_.bra = _.cursor), (r = _.find_among(n, 3))))
                      switch (((_.ket = _.cursor), r)) {
                        case 1:
                          _.slice_from("y");
                          break;
