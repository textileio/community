The command-line client ships alongside the daemon. This section assumes you have a daemon running locally. If you don't, head over to [running the daemon](/run/daemon) before diving in here.
