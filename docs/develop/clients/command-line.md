...
<p><pre>Shows the local peer&#39;s account seed</pre></p>
...
<h3>textile block list [&lt;flags&gt;]</h3>
<p><pre>Paginates blocks in a thread</pre></p>
<table>
	<tr><th>Flag</th><th>Description</th></tr>
	<tr><td><code>-t, --thread=&#34;default&#34;</code></td><td><pre>Thread ID</pre></td></tr>
...
<h3>textile block file [&lt;flags&gt;] &lt;files-block&gt;</h3>
...
<table>
	<tr><th>Flag</th><th>Description</th></tr>
	<tr><td><code>-r, --repo-dir=REPO-DIR</code></td><td><pre>Specify a custom repository path</pre></td></tr>
	<tr><td><code>-p, --pin-code=PIN-CODE</code></td><td><pre>Specify the pin code for datastore encryption (omit no pin code was used during init)</pre></td></tr>
...
<table>
	<tr><th>Flag</th><th>Description</th></tr>
	<tr><td><code>-t, --thread=THREAD</code></td><td><pre>Thread ID, omit for all</pre></td></tr>
...
<h3>textile file list [&lt;flags&gt;]</h3>
<p><pre>Paginates thread files</pre></p>
<table>
	<tr><th>Flag</th><th>Description</th></tr>
	<tr><td><code>-t, --thread=&#34;default&#34;</code></td><td><pre>Thread ID</pre></td></tr>
	<tr><td><code>-o, --offset=OFFSET</code></td><td><pre>Offset ID to start listing from</pre></td></tr>
...
<h3>textile file add [&lt;flags&gt;] [&lt;path&gt;]</h3>
...
<table>
	...
	<tr><th>Argument</th><th>Description</th></tr>
	<tr><td><code>[&lt;path&gt;]</code></td><td><pre>The path to the file or directory to add, can also be an existing hash</pre></td></tr>
</table>
...
<h2>textile init --seed=SEED [&lt;flags&gt;]</h2>
<p><pre>Initialize the node repository and exit</pre></p>
<table>
	<tr><th>Flag</th><th>Description</th></tr>
	<tr><td><code>-s, --seed=SEED</code></td><td><pre>Account seed (run &#39;wallet&#39; command to generate new seeds)</pre></td></tr>
	<tr><td><code>-p, --pin-code=PIN-CODE</code></td><td><pre>Specify a pin code for datastore encryption</pre></td></tr>
	<tr><td><code>-r, --repo-dir=REPO-DIR</code></td><td><pre>Specify a custom repository path</pre></td></tr>
...
<h3>textile invite create [&lt;flags&gt;]</h3>
...
<table>
	<tr><th>Argument</th><th>Description</th></tr>
	<tr><td><code>&lt;block&gt;</code></td><td><pre>Block ID, usually a file&#39;s block</pre></td></tr>
</table>
...
<h3>textile message add [&lt;flags&gt;] [&lt;body&gt;]</h3>
...
<h3>textile message list [&lt;flags&gt;]</h3>
<p><pre>Paginates thread messages</pre></p>
<table>
	<tr><th>Flag</th><th>Description</th></tr>
	<tr><td><code>-t, --thread=THREAD</code></td><td><pre>Thread ID, omit to paginate all messages</pre></td></tr>
...
<table>
	<tr><th>Flag</th><th>Description</th></tr>
	<tr><td><code>-r, --repo-dir=REPO-DIR</code></td><td><pre>Specify a custom repository path</pre></td></tr>
	<tr><td><code>-p, --pin-code=PIN-CODE</code></td><td><pre>Specify the pin code for datastore encryption (omit of none was used during init)</pre></td></tr>
</table>
...
<h2>textile subscribe [&lt;flags&gt;]</h2>
<p><pre>Subscribes to updates in a thread or all threads. An update is generated when a new block is added to a thread.</pre></p>
<table>
	<tr><th>Flag</th><th>Description</th></tr>
	<tr><td><code>-t, --thread=THREAD</code></td><td><pre>Thread ID, omit for all</pre></td></tr>
...
<h3>textile thread default</h3>
<p><pre>Gets and displays info about the default thread (if selected</pre></p>

<h3>textile thread peer [&lt;flags&gt;]</h3>
...
<h3>textile thread rename [&lt;flags&gt;] &lt;name&gt;</h3>
...
<h3>textile thread unsubscribe &lt;thread&gt;</h3>
<p><pre>Unsubscribes from the thread, and if no one else remains subscribed, deletes it</pre></p>
<table>
	<tr><th>Argument</th><th>Description</th></tr>
	<tr><td><code>&lt;thread&gt;</code></td><td><pre>Thread ID</pre></td></tr>
</table>
...
<h3>textile token create [&lt;flags&gt;]</h3>
...
<p><pre>Initialize a new wallet, or view accounts from an existing wallet</pre></p>

<h3>textile wallet init [&lt;flags&gt;]</h3>
<p><pre>Initializes a new account wallet backed by a mnemonic phrase</pre></p>
<table>
	<tr><th>Flag</th><th>Description</th></tr>
	<tr><td><code>-w, --word-count=12</code></td><td><pre>Number of mnemonic phrase words: 12,15,18,21,24</pre></td></tr>
	<tr><td><code>-p, --password=PASSWORD</code></td><td><pre>Mnemonic password (omit if none)</pre></td></tr>
</table>

<h3>textile wallet accounts [&lt;flags&gt;] &lt;mnemonic&gt;</h3>
<p><pre>Shows the derived accounts (address/seed pairs) in a wallet</pre></p>
<table>
	<tr><th>Flag</th><th>Description</th></tr>
	<tr><td><code>-p, --password=PASSWORD</code></td><td><pre>Mnemonic password (omit if none)</pre></td></tr>
	...
	<tr><th>Argument</th><th>Description</th></tr>
	<tr><td><code>&lt;mnemonic&gt;</code></td><td><pre>An existing mnemonic phrase</pre></td></tr>
</table>