  ...
  (function (n) {
              ...
              (t.update = function (e) {
                ...
                var r = this.pad_ ? this.header_.offsetHeight : 0,
                  ...
                  o =
                    ...
                    Math.max(0, t + n - i);
                o !== this.height_ &&
                  (this.el_.style.height = (this.height_ = o) + "px"),
                  t >= this.offset_
              ...
              return (
                ...
                (n.prototype.fetch_ = function () {
                  ...
                  return (function n(r) {
                    return (
                      void 0 === r && (r = 0),
                      fetch(i.base_ + "?per_page=30&page=" + r)
                        .then(function (e) {
                          return e.json();
                        })
                        .then(function (e) {
                          ...
                          if (i.name_) {
                            ...
                            return t || 30 !== e.length
                              ? t
                                ? [
                                    i.format_(t.stargazers_count) + " Stars",
                                    i.format_(t.forks_count) + " Forks",
                                  ]
                                : []
                              : n(r + 1);
                          }
        ...
        f = {
          Toggle: (function () {
            function e(e) {
              ...
              (this.el_ = t), (this.active_ = !1);
            }
            var t = e.prototype;
            return (
              (t.update = function () {
                var e =
                  window.pageYOffset >= this.el_.children[0].offsetTop + -43;
                e !== this.active_ &&
    ...
    function (e, t, n) {
      ...
      function r(e, t) {
        ...
        for (
          var r = arguments.length, i = new Array(2 < r ? r - 2 : 0), o = 2;
          o < r;
          o++
        )
          i[o - 2] = arguments[o];
        ...
        return (function (n) {
          ...
          function (e, t, n) {
            ...
            e.exports = function (e, t, n) {
              ...
              if (d.string(e))
                return (r = e), (i = t), (o = n), h(document.body, r, i, o);
              throw new TypeError(
    ...
    function (r, i, o) {
      ...
      !(function (e) {
        if (
          (void 0 ===
            (s = "function" == typeof (a = e) ? a.call(i, o, i, r) : a) ||
            (r.exports = s),
          !0,
          (r.exports = e()),
          !!0)
          ...
          function p(e, t, n) {
            ...
            if ("undefined" != typeof document) {
              if (1 < arguments.length) {
                if (
                  "number" ==
                  typeof (n = m({ path: "/" }, p.defaults, n)).expires
                ) {
                  var i = new Date();
              ...
              for (
                ...
                try {
                  ...
                  if (
                    ((f = h.read
                      ? h.read(f, d)
                      : h(f, d) || f.replace(c, decodeURIComponent)),
                    this.json)
                  )
                    try {
                      f = JSON.parse(f);
          ...
          : function (i, o) {
              return (
                ...
                new Promise(function (e, t) {
                  ...
                  for (var r in (n.open(o.method || "get", i, !0), o.headers))
                    n.setRequestHeader(r, o.headers[r]);
                  function s() {
                    var r,
                      i = [],
                      o = [],
                  ...
                  (n.withCredentials = "include" == o.credentials),
                    (n.onload = function () {
                      e(s());
                    }),
                    (n.onerror = t),
        ...
        var e = i(10),
          ...
          n = (function () {
            function e(e, t) {
              ...
              a.length && (d.a.tokenizer.separator = a),
                (this.lang_ = h("search.language")
                  .split(",")
                  .filter(Boolean)
                  .map(function (e) {
                    return e.trim();
                ...
                if ("focus" !== e.type || this.index_) {
                  if ("focus" === e.type || "keyup" === e.type) {
                    ...
                    if (!(t instanceof HTMLInputElement))
                      throw new ReferenceError();
                    if (!this.index_ || t.value === this.value_) return;
                    for (; this.list_.firstChild; )
                      this.list_.removeChild(this.list_.firstChild);
                    if (((this.value_ = t.value), 0 === this.value_.length))
                      return void (this.meta_.textContent =
                        this.message_.placeholder);
                    var n = this.index_
                        .query(function (t) {
                          a.value_
                            .toLowerCase()
                      ...
                      r = f()(this.value_.trim()).replace(
                        new RegExp(d.a.tokenizer.separator, "img"),
                        "|"
                      ),
                      s = new RegExp(
                        "(^|" + d.a.tokenizer.separator + ")(" + r + ")",
                        "img"
                      ),
                      c = function (e, t, n) {
                        return t + "<em>" + n + "</em>";
                    ...
                    var i = this.el_.parentNode;
                    if (!(i instanceof HTMLElement)) throw new ReferenceError();
                    for (
                      ;
                      this.stack_.length &&
                      i.offsetHeight >= i.scrollHeight - 16;
                  ...
                  var l = function (e) {
                    a.docs_ = e.reduce(function (e, t) {
                      ...
                      return (
                        (t.text =
                          ...
                          (i = document.createElement("p")).appendChild(r),
                          i.innerHTML)),
                        s &&
                          ((t.parent = e.get(a)),
                          t.parent &&
                            !t.parent.done &&
                            ((t.parent.title = t.title),
                        ...
                        (t.parent && t.parent.title === t.title) ||
                          e.set(t.location, t),
                        e
                      );
                    }, new Map());
                    ...
                    (a.stack_ = []),
                      (a.index_ = d()(function () {
                        ...
                        this.pipeline.reset(),
                          r && (e = this.pipeline).add.apply(e, r),
                          1 === o.length && "en" !== o[0] && d.a[o[0]]
                            ? this.use(d.a[o[0]])
                            : 1 < o.length &&
                              this.use(d.a.multiLanguage.apply(d.a, o)),
                    ...
                    t.addEventListener("scroll", function () {
                      for (
                        ;
                        a.stack_.length &&
                        t.scrollTop + t.offsetHeight >= t.scrollHeight - 16;

                      )
                        a.stack_.splice(0, 10).forEach(function (e) {
                          return e();
                        });
                    });
                  };
                  setTimeout(function () {
                    return "function" == typeof a.data_
                      ? a.data_().then(l)
                      : l(a.data_);
                  }, 250);
                }
          ...
          var t = {
            initialize: function (t) {
              new i.a.Event.Listener(document, "DOMContentLoaded", function () {
                  ...
                  Array.prototype.forEach.call(t, function (e, t) {
                    ...
                    new a.a(".md-clipboard").on("success", function (e) {
                      ...
                      e.clearSelection(),
                        ...
                        (t.innerHTML = s("clipboard.copied")),
                ...
                new i.a.Event.Listener(
                  window,
                  ["scroll", "resize", "orientationchange"],
                  new i.a.Header.Shadow(
                ...
                document.querySelector("[data-md-component=hero]") &&
                  new i.a.Event.Listener(
                    window,
                    ["scroll", "resize", "orientationchange"],
                    new i.a.Tabs.Toggle("[data-md-component=hero]")
                  ).listen(),
                document.querySelector("[data-md-component=tabs]") &&
                  new i.a.Event.Listener(
                    window,
                    ["scroll", "resize", "orientationchange"],
                    new i.a.Tabs.Toggle("[data-md-component=tabs]")
                  ).listen(),
                new i.a.Event.MatchMedia(
                  "(min-width: 1220px)",
                  new i.a.Event.Listener(
                    window,
                    ["scroll", "resize", "orientationchange"],
                    new i.a.Sidebar.Position(
                ...
                new i.a.Event.MatchMedia(
                  ...
                  new i.a.Event.Listener(
                    window,
                    "scroll",
                    new i.a.Nav.Blur("[data-md-component=toc] .md-nav__link")
                  )
                );
              ...
              Array.prototype.forEach.call(e, function (e) {
                ...
                new i.a.Event.MatchMedia(
                  ...
                  new i.a.Event.Listener(
                    ...
                    "change",
                    new i.a.Nav.Scrolling("[data-md-component=navigation] nav")
                  )
                ),
                document.querySelector("[data-md-component=search]") &&
                  (new i.a.Event.MatchMedia(
                    ...
                    new i.a.Event.Listener(
                      "[data-md-toggle=search]",
                      "change",
                      new i.a.Search.Lock("[data-md-toggle=search]")
                    )
                  ),
                  new i.a.Event.Listener(
                    "[data-md-component=query]",
                    ["focus", "keyup", "change"],
                    new i.a.Search.Result(
                        ...
                        return fetch(t.url.base + "/search/search_index.json", {
                          ...
                          .then(function (e) {
                            return e.docs.map(function (e) {
                              return (
                                (e.location = t.url.base + "/" + e.location), e
                              );
                            });
                          });
                      }
                  ...
                  new i.a.Event.Listener(window, "keydown", function (e) {
                    ...
                    if (
                      ...
                      if (t.checked) {
                        if (13 === e.keyCode) {
                          ...
                          var s = Math.max(
                            0,
                            (o.indexOf(a) + o.length + (38 === i ? -1 : 1)) %
                              o.length
                          );
                          return (
                            o[s] &&
                              ((o[s].dataset.mdState = "active"), o[s].focus()),
                            e.preventDefault(),
                            e.stopPropagation(),
                            !1
                          );
                  ...
                  new i.a.Event.Listener(window, "keypress", function () {
                ...
                new i.a.Event.Listener(document.body, "mousedown", function () {
                  var e = document.querySelectorAll(
    ...
    function (e, t) {
      e.exports =
        "/Users/sander/github/squidfunk/mkdocs-material/material/application.86c34351.css";
    },
    function (e, t) {
      e.exports =
        "/Users/sander/github/squidfunk/mkdocs-material/material/application-palette.224b79ff.css";
    },
    function (e, t) {
      !(function () {
       ...
       */ !(function () {
        var t,
          ...
          D = function (e) {
            var t = new D.Builder();
            return (
              t.pipeline.add(D.trimmer, D.stopWordFilter, D.stemmer),
              t.searchPipeline.add(D.stemmer),
              e.call(t, t),
              t.build()
            );
          };
        (D.version = "2.3.6"),
          ...
          (D.FieldRef.joiner = "/"),
          (D.FieldRef.fromString = function (e) {
          ...
          (D.FieldRef.prototype.toString = function () {
            return (
              null == this._stringValue &&
                (this._stringValue =
                  this.fieldName + D.FieldRef.joiner + this.docRef),
              this._stringValue
            );
          }),
          (D.Set = function (e) {
          ...
          (D.tokenizer = function (e, t) {
            ...
            if (Array.isArray(e))
              return e.map(function (e) {
                return new D.Token(
                  D.utils.asString(e).toLowerCase(),
                  D.utils.clone(t)
                );
              });
            for (
              var n = e.toString().trim().toLowerCase(),
                r = n.length,
                i = [],
                o = 0,
                a = 0;
              ...
              if (n.charAt(o).match(D.tokenizer.separator) || o == r) {
                if (0 < s) {
                  ...
                  (c.position = [a, s]),
                    (c.index = i.length),
                    i.push(new D.Token(n.slice(a, o), c));
                }
                a = o + 1;
              }
            }
          ...
          (D.tokenizer.separator = /[\s\-]+/),
          (D.Pipeline = function () {
            this._stack = [];
          }),
          (D.Pipeline.registeredFunctions = Object.create(null)),
          (D.Pipeline.registerFunction = function (e, t) {
            t in this.registeredFunctions &&
              D.utils.warn("Overwriting existing registered function: " + t),
              (e.label = t),
              (D.Pipeline.registeredFunctions[e.label] = e);
          }),
          ...
          (D.stemmer =
            ...
            (r = function (e) {
              ...
              (i = R).test(e) &&
                ...
                (o = h),
                (a = C),
                ((i = d).test(t) || (o.test(t) && !a.test(t))) && (e = t));
              return (
                (o = d),
                (i = O).test(e) &&
                  o.test(e) &&
          ...
          D.Pipeline.registerFunction(D.stemmer, "stemmer"),
          (D.generateStopWordFilter = function (e) {
          ...
          (D.stopWordFilter = D.generateStopWordFilter([
            "a",
            "able",
            "about",
            "across",
          ...
          D.Pipeline.registerFunction(D.stopWordFilter, "stopWordFilter"),
          (D.trimmer = function (e) {
            return e.update(function (e) {
              return e.replace(/^\W+/, "").replace(/\W+$/, "");
            });
          }),
          D.Pipeline.registerFunction(D.trimmer, "trimmer"),
          (D.TokenSet = function () {
            (this.final = !1),
              (this.edges = {}),
              (this.id = D.TokenSet._nextId),
              (D.TokenSet._nextId += 1);
          }),
          (D.TokenSet._nextId = 1),
          (D.TokenSet.fromArray = function (e) {
            for (
              var t = new D.TokenSet.Builder(), n = 0, r = e.length;
              n < r;
              n++
            )
              t.insert(e[n]);
          ...
          (D.TokenSet.fromClause = function (e) {
            return "editDistance" in e
              ? D.TokenSet.fromFuzzyString(e.term, e.editDistance)
              : D.TokenSet.fromString(e.term);
          }),
          (D.TokenSet.fromFuzzyString = function (e, t) {
            for (
              var n = new D.TokenSet(),
              ...
              if (0 < i.str.length) {
                ...
                a in i.node.edges
                  ? (o = i.node.edges[a])
                  : ((o = new D.TokenSet()), (i.node.edges[a] = o)),
              ...
              if (0 != i.editsRemaining) {
                ...
                if (1 < i.str.length) {
                  ...
                  f in i.node.edges
                    ? (l = i.node.edges[f])
                    : ((l = new D.TokenSet()), (i.node.edges[f] = l)),
          ...
          (D.TokenSet.fromString = function (e) {
            for (
              var t = new D.TokenSet(), n = t, r = 0, i = e.length;
              r < i;
              r++
            ) {
              var o = e[r],
                ...
                for (var l = i[c], u = 0; u < s; u++) {
                  ...
                  if (f == l || "*" == l) {
                    var d = n.node.edges[f],
                      ...
                      m = void 0;
                    f in n.output.edges
                      ? ((m = n.output.edges[f]).final = m.final || p)
                      : (((m = new D.TokenSet()).final = p),
                        (n.output.edges[f] = m)),
                      r.push({ qNode: h, output: m, node: d });
                  }
                }
            }
            return t;
          ...
          (D.Index.prototype.query = function (e) {
            ...
            for (s = 0; s < t.clauses.length; s++) {
              ...
              for (var f = 0; f < l.length; f++) {
                ...
                if (
                  0 === p.length &&
                  c.presence === D.Query.presence.REQUIRED
                ) {
                ...
                for (var y = 0; y < p.length; y++) {
                  ...
                  for (m = 0; m < c.fields.length; m++) {
                    ...
                    if (
                      (c.presence == D.Query.presence.REQUIRED &&
                        ((u = u.union(b)),
                        void 0 === o[Q] && (o[Q] = D.Set.complete)),
                      c.presence != D.Query.presence.PROHIBITED)
                    ) {
                      if (
                        (r[Q].upsert(w, c.boost, function (e, t) {
                          return e + t;
                        }),
                        !i[x])
                      ) {
                        for (var k = 0; k < E.length; k++) {
                          var S,
                            ...
                            R = _[T];
                          void 0 === (S = n[L])
                            ? (n[L] = new D.MatchData(v, Q, R))
                            : S.add(v, Q, R);
                        }
                        i[x] = !0;
                      }
                    } else
                      void 0 === a[Q] && (a[Q] = D.Set.empty),
                        (a[Q] = a[Q].union(b));
                  }
                }
              }
            ...
            for (s = 0; s < this.fields.length; s++) {
              var Q;
              o[(Q = this.fields[s])] && (O = O.intersect(o[Q])),
                a[Q] && (C = C.union(a[Q]));
            }
            var P = Object.keys(n),
              I = [],
            ...
            for (s = 0; s < P.length; s++) {
              ...
              if (O.contains(N) && !C.contains(N)) {
                var j,
                  F = this.fieldVectors[M],
                  H = r[M.fieldName].similarity(F);
                if (void 0 !== (j = A[N]))
                  (j.score += H), j.matchData.combine(n[M]);
                else {
                  var q = { ref: N, score: H, matchData: n[M] };
                  (A[N] = q), I.push(q);
                }
              }
            }
          ...
          (D.Builder = function () {
            (this._ref = "id"),
              ...
              (this.fieldLengths = {}),
              (this.tokenizer = D.tokenizer),
              (this.pipeline = new D.Pipeline()),
              (this.searchPipeline = new D.Pipeline()),
          ...
          (D.Builder.prototype.add = function (e, t) {
            ...
            for (var i = 0; i < r.length; i++) {
              ...
              for (var d = 0; d < l.length; d++) {
                ...
                null == this.invertedIndex[h][o][n] &&
                  (this.invertedIndex[h][o][n] = Object.create(null));
                for (var y = 0; y < this.metadataWhitelist.length; y++) {
                  var v = this.metadataWhitelist[y],
                    g = h.metadata[v];
                  null == this.invertedIndex[h][o][n][v] &&
                    (this.invertedIndex[h][o][n][v] = []),
                    this.invertedIndex[h][o][n][v].push(g);
                }
              }
            }
          }),
          ...
          (D.Builder.prototype.createFieldVectors = function () {
            for (
              ...
              for (
                var o = D.FieldRef.fromString(t[i]),
                  a = o.fieldName,
                ...
                void 0 === r[g]
                  ? ((m = D.idf(this.invertedIndex[g], this.documentCount)),
                    (r[g] = m))
                  : (m = r[g]),
                  (y =
                    (m * ((this._k1 + 1) * w)) /
                    (this._k1 *
                      (1 -
                        this._b +
                        this._b * (s / this.averageFieldLength[a])) +
                      w)),
                  (y *= d),
                  (y *= h),
          ...
          (D.Builder.prototype.createTokenSet = function () {
            this.tokenSet = D.TokenSet.fromArray(
            ...
            for (var t = Object.keys(e.metadata), n = 0; n < t.length; n++) {
              ...
              for (var o = 0; o < i.length; o++) {
                ...
                for (var c = 0; c < s.length; c++) {
                  var l = s[c];
                  null == this.metadata[r][a][l]
                    ? (this.metadata[r][a][l] = e.metadata[r][a][l])
                    : (this.metadata[r][a][l] = this.metadata[r][a][l].concat(
                        e.metadata[r][a][l]
                      ));
                }
              }
          ...
          (D.Query.wildcard = new String("*")),
          (D.Query.wildcard.NONE = 0),
          (D.Query.wildcard.LEADING = 1),
          (D.Query.wildcard.TRAILING = 2),
          (D.Query.presence = { OPTIONAL: 1, REQUIRED: 2, PROHIBITED: 3 }),
          (D.Query.prototype.clause = function (e) {
            return (
              ...
              "wildcard" in e || (e.wildcard = D.Query.wildcard.NONE),
              e.wildcard & D.Query.wildcard.LEADING &&
                e.term.charAt(0) != D.Query.wildcard &&
                (e.term = "*" + e.term),
              e.wildcard & D.Query.wildcard.TRAILING &&
                e.term.slice(-1) != D.Query.wildcard &&
                (e.term = e.term + "*"),
              "presence" in e || (e.presence = D.Query.presence.OPTIONAL),
              this.clauses.push(e),
              this
            );
          }),
          (D.Query.prototype.isNegated = function () {
            for (var e = 0; e < this.clauses.length; e++)
              if (this.clauses[e].presence != D.Query.presence.PROHIBITED)
                return !1;
            return !0;
          }),
          ...
          (D.QueryParseError.prototype = new Error()),
          (D.QueryLexer = function (e) {
            (this.lexemes = []),
              (this.str = e),
              (this.length = e.length),
              (this.pos = 0),
          ...
          (D.QueryLexer.prototype.acceptDigitRun = function () {
            for (
              var e, t;
              47 < (t = (e = this.next()).charCodeAt(0)) && t < 58;
          ...
          (D.QueryLexer.EOS = "EOS"),
          (D.QueryLexer.FIELD = "FIELD"),
          (D.QueryLexer.TERM = "TERM"),
          (D.QueryLexer.EDIT_DISTANCE = "EDIT_DISTANCE"),
          (D.QueryLexer.BOOST = "BOOST"),
          (D.QueryLexer.PRESENCE = "PRESENCE"),
          (D.QueryLexer.lexField = function (e) {
            return (
              e.backup(),
              e.emit(D.QueryLexer.FIELD),
              e.ignore(),
              D.QueryLexer.lexText
            );
          }),
          (D.QueryLexer.lexTerm = function (e) {
            if (
              (1 < e.width() && (e.backup(), e.emit(D.QueryLexer.TERM)),
              e.ignore(),
              e.more())
            )
              return D.QueryLexer.lexText;
          }),
          (D.QueryLexer.lexEditDistance = function (e) {
            return (
              e.ignore(),
              e.acceptDigitRun(),
              e.emit(D.QueryLexer.EDIT_DISTANCE),
              D.QueryLexer.lexText
            );
          }),
          ...
          (D.QueryLexer.termSeparator = D.tokenizer.separator),
          (D.QueryLexer.lexText = function (e) {
            for (;;) {
              var t = e.next();
              ...
              if (92 != t.charCodeAt(0)) {
                ...
                if ("+" == t && 1 === e.width())
                  return e.emit(D.QueryLexer.PRESENCE), D.QueryLexer.lexText;
                if ("-" == t && 1 === e.width())
                  return e.emit(D.QueryLexer.PRESENCE), D.QueryLexer.lexText;
                if (t.match(D.QueryLexer.termSeparator))
                  return D.QueryLexer.lexTerm;
              } else e.escapeCharacter();
            }
          }),
          (D.QueryParser = function (e, t) {
            (this.lexer = new D.QueryLexer(e)),
              (this.query = t),
              (this.currentClause = {}),
              (this.lexemeIdx = 0);
          }),
            ...
            if (null != t)
              switch (t.type) {
                ...
                default:
                  ...
                  throw (
                    (1 <= t.str.length && (n += " with value '" + t.str + "'"),
                    new D.QueryParseError(n, t.start, t.end))
                  );
              }
          }),
            ...
            if (null != t) {
              if (-1 == e.query.allFields.indexOf(t.str)) {
                var n = e.query.allFields
                    ...
                    .join(", "),
                  r =
                    "unrecognised field '" + t.str + "', possible fields: " + n;
