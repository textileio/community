  ...
  return function (e) {
    ...
    console.warn(
      ...
      (e.du.stemmer =
        ...
        (q = e.stemmerSupport.SnowballProgram),
        (r = new (function () {
          var r,
            i,
            u,
            ...
            n = [new v("", -1, 3), new v("I", 0, 2), new v("Y", 0, 1)],
            t = [new v("dd", -1, -1), new v("kk", -1, -1), new v("tt", -1, -1)],
            c = [
              new v("ene", -1, 2),
              new v("se", -1, 3),
              new v("en", -1, 2),
            ...
            _ = new q();
          function s(e) {
            return (_.cursor = e) >= _.limit || (_.cursor++, !1);
          }
          function w() {
              ...
              _.eq_s_b(1, "e") &&
                ...
                b() &&
                  ...
                  _.out_grouping_b(m, 97, 232) &&
                    ((_.cursor = _.limit - e), _.slice_del(), (u = !0), g())));
          }
          function k() {
            var e;
            b() &&
              ...
              _.out_grouping_b(m, 97, 232) &&
                ((_.cursor = _.limit - e),
                _.eq_s_b(3, "gem") ||
                  ((_.cursor = _.limit - e), _.slice_del(), g())));
          }
          (this.setCurrent = function (e) {
            ...
            (this.stem = function () {
              ...
              return (
                (function () {
                  for (var e, r, i, n = _.cursor; ; ) {
                    if (((_.bra = _.cursor), (e = _.find_among(o, 11))))
                  ...
                  for (
                    ...
                    if (((r = _.cursor), _.in_grouping(m, 97, 232))) {
                      if (((i = _.cursor), (_.bra = i), _.eq_s(1, "i")))
                        (_.ket = _.cursor),
                          _.in_grouping(m, 97, 232) &&
                            (_.slice_from("I"), (_.cursor = r));
                      else if (((_.cursor = i), _.eq_s(1, "y")))
                        (_.ket = _.cursor), _.slice_from("Y"), (_.cursor = r);
                      else if (s(r)) break;
                    } else if (s(r)) break;
                })(),
                (_.cursor = e),
                (i = _.limit),
                (r = i),
                w() || ((i = _.cursor) < 3 && (i = 3), w() || (r = _.cursor)),
                (_.limit_backward = e),
                (_.cursor = _.limit),
                (function () {
                  var e,
                    ...
                    t,
                    s = _.limit - _.cursor;
                  if (((_.ket = _.cursor), (e = _.find_among_b(c, 5))))
                    switch (((_.bra = _.cursor), e)) {
                      ...
                      case 2:
                        ...
                        break;
                      case 3:
                        b() && _.out_grouping_b(f, 97, 232) && _.slice_del();
                    }
                  if (
                    ((_.cursor = _.limit - s),
                    h(),
                    ...
                    _.eq_s_b(4, "heid") &&
                      ...
                      p() &&
                        ...
                        _.eq_s_b(1, "c") ||
                          ...
                          _.slice_del(),
                          (_.ket = _.cursor),
                          _.eq_s_b(2, "en") && ((_.bra = _.cursor), k())))),
                    (_.cursor = _.limit - s),
                    (_.ket = _.cursor),
                    (e = _.find_among_b(a, 6)))
                  )
                    switch (((_.bra = _.cursor), e)) {
                      case 1:
                        if (p()) {
                      ...
                      case 2:
                        p() &&
                          ((o = _.limit - _.cursor),
                          _.eq_s_b(1, "e") ||
                            ((_.cursor = _.limit - o), _.slice_del()));
                        break;
                      case 3:
                        p() && (_.slice_del(), h());
                        break;
                ...
                (function () {
                  for (var e; ; )
                    if (((_.bra = _.cursor), (e = _.find_among(n, 3))))
                      switch (((_.ket = _.cursor), e)) {
                        case 1:
                          _.slice_from("y");
                          break;
